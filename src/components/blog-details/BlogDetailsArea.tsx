                    ...
                    <div className="col-lg-8">
                      <div className="postbox__main-wrapper">
                        ...
                        <div className="postbox__details-content-wrapper">
                          <h3 className="postbox__details-title">Podyumlar ne kadar etkili olsa da, trendler yalnızca <br /> onları doğurdu. Sosyal medya platformlarına gelen net bir yön vardı.</h3>
                          <p>Bir sabah, Gregor Samsa sıkıntılı rüyalardan uyandığında, kendini yatağında korkunç bir böceğe dönüşmüş halde buldu. Zırh gibi sırt üstü yatıyordu ve başını biraz kaldırdığında, hafifçe kubbeleşmiş ve kemerlerle sert bölümlere ayrılmış kahverengi karnını görebiliyordu. Yatak örtüsü onu zar zor örtebiliyordu ve her an kayacak gibi görünüyordu.</p>
                          <p>Şu anda tek bir çizgi bile çizemezdim; ama yine de hiçbir zaman şu andan daha büyük bir sanatçı olmadığını hissediyorum.</p>
                          <div className="postbox__img m-img mt-50 mb-45">
                            <img src="assets/images/blog/blog1.jpg" alt="" />
                            <h5 className="postbox__img-caption">Image by <a href="#">@example01</a></h5>
                          </div>
                          <p>Geri kalanıyla kıyaslandığında acınacak derecede ince olan çok sayıdaki bacakları, bakarken çaresizce sallanıyordu. "Bana ne oldu?" diye düşündü. Bu bir rüya değildi. Odası, biraz fazla küçük olmasına rağmen düzgün bir insan odası, dört tanıdık duvarının arasında huzur içinde uzanıyordu. Masanın üzerinde bir tekstil örnekleri koleksiyonu yayılmıştı - Samsa seyyar bir satıcıydı - ve üstünde yakın zamanda resimli bir dergiden kestiği bir resim asılıydı.
                          </p>
                          <div className="postbox__quote">
                            <blockquote>
                              ...
                              <p>“Size mümkün olduğunca harika bir temel ürün sunmaya çalışıyorum ve ortaya çıkan şeyin gerçekten harika olduğunu düşünüyorum.”</p>
                            </blockquote>
                          </div>
                          <div className="postbox__features">
                            <h4 className="postbox__features-title">Başarısızlıktan ders almak</h4>
                            <p>Avrupa dilleri aynı ailenin üyeleridir. Ayrı varoluşları bir efsanedir. Avrupa bilim için aynı kelime dağarcığını kullanır.</p>
                            <ul>
                              <li>
                                Rahat olun.</li>
                              <li>Çalışma alanınızı yönetin ve masanızı organize edin.</li>
                              <li>İş arkadaşlarınızla iletişim halinde olun.</li>
                            </ul>
                          </div>
                          <p>Yeni ortak dil, mevcut Avrupa dillerinden daha basit ve düzenli olacak. Occidental kadar basit olacak; hatta Occidental olacak. Bir İngiliz için, şüpheci bir Cambridge arkadaşımın bana Occidental'in ne olduğunu söylediği gibi, basitleştirilmiş İngilizce gibi görünecek. Avrupa dilleri aynı ailenin üyeleridir.</p>
                        </div>
                        ...
                        <div className="postbox__comment-wrapper">
                              ...
                              <li>
                                <div className="postbox__comment-box d-sm-flex align-items-start">
                                  ...
                                  <div className="postbox__comment-text ">
                                    ...
                                    <p>Şu anda bulabileceğiniz en iyi şablonlardan biri. Tasarım, kod kalitesi, güncellemeler vb. ihtiyacınız olan her şey var arkadaşlar, satın alın pişman olmayacaksınız!</p>
                                  ...
                                  <li>
                                    <div className="postbox__comment-box d-sm-flex align-items-start">
                                      ...
                                      <div className="postbox__comment-text ">
                                        ...
                                        <p>Bu tema süper harika! Ama parallax portföyündeki bağlantı seçeneğiyle ilgili küçük bir sorunum vardı. Geçen gün!</p>
                                        <div className="postbox__comment-reply">
                                          <a href="#">Reply</a>
                                        </div>
                                      </div>
                              ...
                              <li>
                                <div className="postbox__comment-box d-sm-flex align-items-start">
                                  ...
                                  <div className="postbox__comment-text ">
                                    ...
                                    <p>Geri kalanıyla karşılaştırıldığında acınacak derecede ince olan çok sayıdaki bacakları, çaresizce sallanıyordu.</p>
                                    <div className="postbox__comment-reply">
                                      <a href="#">Reply</a>
                                    </div>
                                  </div>
                          ...
                          <div className="postbox__comment-form">
                            ...
                            <p>E-posta adresiniz yayınlanmayacak. Gerekli alanlar işaretlenmiştir
                              *</p>
                            <form action="#">
                              <div className="row">
                                ...
                                <div className="col-xxl-12">
                                  <div className="postbox__comment-agree d-flex align-items-start mb-25">
                                    ...
                                    <label className="e-check-label" htmlFor="e-agree">
                                      Adımı, e-postamı ve web sitemi bir dahaki sefere yorum yaptığımda bu tarayıcıya kaydet.</label>
                                  </div>
                                </div>
                                <div className="col-xxl-12">
                                  <div className="postbox__comment-btn">
                                    <button type="submit" className="theme-btn theme-btn-two">
                                      Yorum Gönder</button>
                                  </div>
                                </div>
                              </div>
                    ...
                    <div className="col-xxl-4 col-lg-4">
                      <div className="blog_sidebar__wrapper pl-40">
                          ...
                          <div className="sidebar__widget-content">
                            <div className="sidebar__author">
                              ...
                              <div className="sidebar__author-content">
                                <h3 className="sidebar__author-title">Ali Ördek</h3>
                                <p>Küçük adımlarla başlayıp büyük işler başarabilirsin..</p>
                          ...
                          <div className="sidebar__widget-content">
                            <div className="sidebar__post">
                              <div className="rc__post d-flex align-items-center">
                                ...
                                <div className="rc__post-content">
                                  <h3 className="rc__post-title">
                                    <a href="#">
                                      2021 San Francisco'daki iş toplantısı</a>
                                  </h3>
                              ...
                              <div className="rc__post d-flex align-items-center">
                                ...
                                <div className="rc__post-content">
                                  <h3 className="rc__post-title">
                                    <a href="#">Gizlilik odaklı kullanıcı merkezli uygulamalar geliştirmek</a>
                                  </h3>
                                  <div className="rc__meta">
                                    <span>
                                      <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                              ...
                              <div className="rc__post d-flex align-items-center">
                                ...
                                <div className="rc__post-content">
                                  <h3 className="rc__post-title">
                                    <a href="#">2022'de Web Tasarımına Başlamak ve Büyütmek</a>
                                  </h3>
                                  <div className="rc__meta">
                                    <span>
                                      <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="sidebar__widget mb-45">
                          ...
                          <div className="sidebar__widget-content">
                            <ul>
                              <li><Link to="/blog">Tasarım Medyası <span>10</span></Link></li>
                              <li><Link to="/blog">
                                Figma Tasarım <span>08</span></Link></li>
                              <li><Link to="/blog">Web Tasarımı <span>24</span></Link></li>
                              <li><Link to="/blog">Wix Geliştirme <span>37</span></Link></li>
                              <li><Link to="/blog">Çerçeveleyici Web Sitesi <span>103</span></Link></li>
                            </ul>
                          </div>
                        </div>
